...
if($mode == 0){
?>
<h1>ยอดขายสินค้าสะสม</h1>
<form method="post">
<input type="hidden" name="mode" id="mode" value="<?=$mode;?>" />
<input type="hidden" name="report_name" value="shop_revenue" />
...
?>
<div style="margin: 0; padding: 0;"><h1>ยอดขายสินค้าสะสม</h1></div>
<br />
...
<tr class="thead">
	<td colspan=2 style="vertical-align: middle; text-align: center;">สาขา และ ประเภทเงิน</td>
...
?>
<tr class="tbody">
	<td rowspan=2 style="vertical-align: middle; text-align: left;<?php if($index % 2 != 0) { ?> background-color: white;<?php } if($index == (count($branch_id)) - 1) echo " border-bottom: none;";?>"><?=$branch_name[$index];?></td>
